...
class BamlAsyncClient:
    ...
    async def ExtractDynamic(self, prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> types.DynamicOutput:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractDynamic(prompt=prompt,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractDynamic", args={
                "prompt": prompt,
            })
...
class BamlStreamClient:
    ...
    def ExtractDynamic(self, prompt: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.DynamicOutput, types.DynamicOutput]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractDynamic", args={
            "prompt": prompt,
        })
...
class BamlHttpRequestClient:
    ...
    async def ExtractDynamic(self, prompt: str,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractDynamic", args={
            "prompt": prompt,
        }, mode="request")
        return __result__
